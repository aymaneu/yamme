    ...
    <div className="max-w-5xl h-full min-h-screen border-r border-l border-dashed border-subOrange mx-auto">
      ...
      <div className="pt-28">
        <p
          className={cn(
            playfair.className,
            "text-center border-b border-dashed border-subOrange pb-10 max-w-2xl mx-auto text-subOrange text-lg md:text-[2rem]"
          )}
        >
          Privacy Policy
        </p>
        <div className="flex mt-10 flex-col px-5 gap-5 max-w-3xl mx-auto">
          <p className="text-start text-secondary/75 text-sm md:text-base italic">
          ...
          <h2 className="text-start text-sm md:text-base italic">
            Information We Collect
          </h2>
          <p className="text-start text-sm md:text-base text-secondary/75 italic">
          ...
          <h2 className="text-start italic text-sm md:text-base">
            How We Use Your Information
          </h2>
          <p className="text-start text-sm md:text-base text-secondary/75 italic">
            We may use the information we collect from you to:
          </p>
          <ul className="list-disc text-sm md:text-base list-inside">
          ...
          <h2 className="text-start text-sm md:text-base italic">Contact Us</h2>
          <p className="text-start text-sm md:text-base text-secondary/75 italic">
