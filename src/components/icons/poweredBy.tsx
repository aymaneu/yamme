  ...
  return (
    ...
    >
      <g fill-rule="nonzero" fill="none">
        <path
          d="M.227 16.108c0-2.1 1.8-3.9 3.9-3.9 2.2 0 3.9 1.7 3.9 3.9 0 2.1-1.8 3.9-3.9 3.9-2.1-.1-3.9-1.8-3.9-3.9zm27.6 3.8c-2.2 0-3.9-1.7-3.9-3.9 0-2.1 1.8-3.9 3.9-3.9 2.2 0 3.9 1.7 3.9 3.9s-1.7 3.9-3.9 3.9zm0-19.3c-8.7 0-15.7 6.9-15.7 15.5s7 15.5 15.7 15.5 15.7-6.9 15.7-15.5-7-15.5-15.7-15.5z"
          fill="#DA3743"
        />
        <path
